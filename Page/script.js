...
function saveCanvas() {
    ...
    if (!hasPaintedPixel) {
        if (languageToUse === "de") {
            alert("Leere Bereiche können nicht gespeichert werden!");
        } else {
...
const languageToUse = userLanguage.startsWith("de") ? "de" : "en";
...
function loadLanguageResources() {
    ...
    scriptElement.src = `../Translation/lang-${languageToUse}.js`;
...
saveImgBtn.style.padding = (languageToUse === "de") ? "11px 5px 11px 5px" : "8px 16px";
toolsHeader.style.fontSize = (languageToUse === "de") ? "21px" : "";